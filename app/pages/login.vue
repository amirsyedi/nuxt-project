  ...
  <div class="flex min-h-screen items-center justify-center bg-zinc-900 px-4">
    <div class="w-full max-w-md space-y-6 rounded-xl bg-gray-50 p-8 shadow-md">
      <div class="text-center">
        ...
        <p class="mt-2 text-sm text-gray-600">Ada udang disebalik mee, tapi mee tak goreng lagi.</p>
      </div>
        ...
        <div>
          ...
          <div class="relative mt-1">
            <input
              ...
              required
              class="block w-full rounded-lg border border-gray-300 px-3 py-2 pr-10 text-gray-900 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
              placeholder="password123"
            />
            <button
              type="button"
              @click="showPassword = !showPassword"
              class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-blue-500 focus:outline-none"
            >
              <!-- Eye Icon (Show) -->
              <svg
                v-if="!showPassword"
